...
from src.listen_full.engine.netease.api_netease import NetEase
from src.listen_full.engine.netease.netease_flac_downloader import NeteaseDownloader
from src.listen_full.engine.qq.api_qq import QQ
from src.listen_full.engine.xiami.api_xiami import Xiami
...
def netease_flac():
    ...
    NeteaseDownloader(CURRENT_PATH, 'files/netease_flac').downloader('https://music.163.com/#/playlist?id=2650235005')
